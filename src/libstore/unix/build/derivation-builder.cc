...
protected:
    ...
    struct ChrootPath {
        ...
        bool optional;
        bool rdonly;
        ChrootPath(Path source = "", bool optional = false, rdonly = false)
...
DerivationBuilderImpl::PathsInChroot DerivationBuilderImpl::getPathsInSandbox()
{
    ...
    for (auto i : settings.sandboxPaths.get()) {
        ...
        //}
        //bool rdonly = false;
        //if (i.size() > 3 && i.substr(i.size() - 3) == ":ro") {
        //    rdonly = true;
        //    i.resize(i.size() - 3);
        //}
        //size_t p = i.find('=');
        //if (p == std::string::npos)
        //    pathsInChroot[i] = {i, optional, rdonly};
        //else
        //    pathsInChroot[i.substr(0, p)] = {i.substr(p + 1), optional, rdonly};
    }
