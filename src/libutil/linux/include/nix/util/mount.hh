...
inline constexpr MountFlags MOUNT_OPTIONS_MASKS[] = {MOUNT_OPTIONS_ATIME, MOUNT_OPTIONS_PROPAGATION};
...
constexpr MountFlags mountOptionAttr(const MountFlags fs) noexcept
{
    constexpr auto keyMask = ([](const auto & items) {
        MountFlags r = 0;
...
inline constexpr std::pair<std::string_view, MountFlags> mountOptionStrings[] = {MOUNT_OPTION_LIST};
...
enum class MountOpt : MountFlags { MOUNT_OPTION_LIST };
#undef MOUNT_OPTION_ITEM
